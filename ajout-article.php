              ...
              <div class="inscription-right col-md-6 text-center p-5">
                <form action="ajouterarticle.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="text" name="nomArticle" placeholder="Nom du produit" class="form-control emall-input">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="number" name="prix" placeholder="Prix" class="form-control emall-input">
                    </div>
                    <div class="form-group">
