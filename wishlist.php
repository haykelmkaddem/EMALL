...
$cart="SELECT * FROM wishlist where id_client ='$idClient'";   
        ...
        <div class="card" style="height:100px; border-bottom-right-radius:15px; padding:0px; margin:0px; margin-top:10px;">
               <div class="row">
                    ...
                    <div class="col-md-6" style="text-align:center;">
                        <h3  class="text-danger"><?php echo $row1[1]; ?></h3>
                        <h4><?php echo $row1[4]; ?> TND</h4>

                    </div>
                  
                    <div class="col-md-3" style="text-align:center;">
                        <a href="add-to-cart.php?id=<?php echo $row1[0]; ?>" class="btn btn-emall-top-left-rounded mt-3 mb-2">Acheter</a>
                        <br>
                        <a href="deletefromwishlist.php?id=<?php echo $row[0]; ?>" class="text-danger">Supprimer </a>
                    </div>
               </div>
           </div>
        <?php 
