                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="nom" placeholder="Nom" class="form-control emall-input" value="<?php echo $row[1]; ?>" >
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="prenom" placeholder="Prenom" class="form-control emall-input" value="<?php echo $row[2]; ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="date" name="dateNaissance" placeholder="Date de naissance" class="form-control emall-input" value="<?php echo $row[3]; ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="number" name="tel" placeholder="Numéro de téléphone" class="form-control emall-input" value="<?php echo $row[4]; ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="mail" name="mail" placeholder="Adresse email" class="form-control emall-input" value="<?php echo $row[5]; ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group mt-5">
                                        <input type="submit" name="updateinfo" value="mettre a jour" class="btn-emall-top-left-rounded">
                                    </div>
                                </div>
                            </div>
                            <?php endwhile; ?>
                ...
                <div class="col-md-3">
                  ...
                  <div class="card-profile-shodow">
                      <div class="row" style="margin-bottom:20px;">
                        <div style="width:33%;">
                          <img src="img/TOD_0005.jpg" class="rounded-avatar" style="height:50px; width:50px;" alt="">
                        </div>
