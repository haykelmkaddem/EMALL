              ...
              <div class="inscription-right col-md-6 text-center p-5">
                <form action="signup.php" method="post" enctype='multipart/form-data'>
                    <div class="form-group">
                        <input type="text" name="nom" placeholder="Nom" class="form-control emall-input">
                    </div>
                    <div class="form-group">
                        <input type="text" name="prenom" placeholder="Prenom" class="form-control emall-input">
                    </div>
                    <div class="form-group">
                        <input type="date" name="dateNaissance" placeholder="Date de naissance" class="form-control emall-input">
                    </div>
                    <div class="form-group">
                        <input type="number" name="tel" placeholder="Numéro de téléphone" class="form-control emall-input">
                    </div>
                    <div class="form-group">
                        <input type="mail" name="mail" placeholder="Adresse email" class="form-control emall-input">
                    </div>
                    <div class="form-group">
                        <input type="file" name="file" placeholder="img" class="form-control emall-input">
                    </div>
                    <div class="form-group">
                        <input type="password" name="pwd" placeholder="Mot de passe" class="form-control emall-input">
                    </div>

                    <div class="form-check form-check-inline">
                        <input class="form-check-input " type="radio" name="role" id="role1" value="client" checked>
                      ...
                      <div class="form-check form-check-inline">
                        <input class="form-check-input " type="radio" name="role" id="role2" value="moderateur">
                      ...
                      <div class="form-group mt-5">
                        <input type="submit" name="submit" value="Inscrivez-vous" class="btn-emall-top-left-rounded">
                    </div>
                </form>
              </div>
            </div>
